...
class FallbackScorer:
    ...
    def get_dataset_fallback_score(self) -> Tuple[float, Dict[str, Any]]:
        ...
        if llm_score >= 0:
            ...
            # Apply cube root scaling for stronger boost of lower scores
            # cbrt(0.157) = 0.540, cbrt(0.352) = 0.707, cbrt(0.8) = 0.928
            ...
            # Apply cube root scaling to deterministic score too
            final_score = final_score ** (1/3)
            details = det_details
            logger.info(
